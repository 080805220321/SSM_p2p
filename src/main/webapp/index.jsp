...
<div class="top">
  <div class="wrap clearfix">
    ...
    <span class="fr"><a href="login.jsp" class="loginbtn">登录</a><a href="register.jsp" class="o regbtn">免费注册</a><a href="about.jsp">帮助中心</a></span>
  </div>
</div>
<div class="head">
  <div class="wrap pct-h clearfix">
    ...
    <ul class="nav">
      ...
      <li><a href="login.jsp">我要投资</a></li>
      <li><a href="login.jsp">我要借款</a></li>
...
<div class="banner">
  <div id="inner">
    <div class="hot-event">
      ...
      <div class="event-item" style="background-color:#c20000; background-image:url(upload/img4.jpg);"><a href="index.jsp" title="十七金融"></a></div>
      <div class="event-item" style="background-color:#c20000; background-image:url(upload/img4.jpg);"><a href="index.jsp" title="十七金融"></a></div>
      <div class="event-item" style="background-color:#c20000; background-image:url(upload/img4.jpg);"><a href="index.jsp" title="十七金融"></a></div>
...
<div class="wrap mt10 clearfix">
  <div class="indexsection fl">
      ...
      <div class="bd clearfix">
        <div class="item">
          ...
          <div class="progress fl">
            <div class="ui-progressbar-mid" style="background:url(images/100.png) no-repeat center;">100%</div>
            <a href="invest-list.jsp" class="ico btn-Tender">投标</a>
            剩余金额 70,000元
          </div>
        </div>
        <div class="item">
          ...
          <div class="progress fl">
            <div class="ui-progressbar-mid" style="background:url(images/75.png) no-repeat center;">75%</div>
            <a href="invest-list.jsp" class="ico btn-Tender">投标</a>
            剩余金额 250,000元
          </div>
        </div>
        <div class="item">
          ...
          <div class="progress fl">
            <div class="ui-progressbar-mid" style="background:url(images/50.png) no-repeat center;">50%</div>
            <a href="invest-list.jsp" class="ico btn-Tender">投标</a>
            剩余金额 250,000元
          </div>
        </div>
    ...
    <div class="Recommendation mt10 bdr">
      ...
      <dl>
        <dt class="clearfix"><a href="invest-list.jsp" class="button ico Bid">投标</a><em class="ico Guarantee">保</em>园博印象旅游珠宝商户进货<span class="Guarantee-Agency">  担保机构：安徽融桥担保股份有限公司</span></dt>
        <dd>
  ...
  <div class="indexaside fr">
    ...
    <div class="mt10 bd bdr">
      <!--Notice-->
      <div class="hd clearfix"><a href="news.jsp" class="more">更多&gt;&gt;</a>网站公告</div>
      <ul class="Notice cicle clearfix">
        <li><span class="time">[10-11]</span><a href="newshow.jsp">电子工程师严定贵的二次创业</a></li>
        <li><span class="time">[10-11]</span><a href="newshow.jsp">严定贵：互联网大鳄搅局将抬高</a></li>
        <li><span class="time">[10-11]</span><a href="newshow.jsp">以产品定义为先导 促P2P阳光化</a></li>
        <li><span class="time">[10-11]</span><a href="newshow.jsp">IT168视频采访副总裁刘瑶</a></li>
        <li><span class="time">[10-11]</span><a href="newshow.jsp">IT168视频采访副总裁刘瑶</a></li>
        <li><span class="time">[10-11]</span><a href="newshow.jsp">P2P监管“冲刺” 市场迎洗牌</a></li>
      </ul>
      <!-- reports-->
      <div class="hd mt10 clearfix"><a href="reports.jsp" class="more">更多&gt;&gt;</a>媒体报道</div>
      <div class="reports mt10 clearfix">
        <dl class="clearfix">
          <dt class="img"><a href="reportshow.jsp"><img src="upload/img5.jpg"></a></dt>
          <dd><a href="newshow.jsp">互联网金融应该充当毛细血管的角色-上海法治声音</a></dd>
        </dl>
        <dl class="clearfix">
          <dt class="img"><a href="reportshow.jsp"><img src="upload/img6.jpg"></a></dt>
          <dd><a href="newshow.jsp">互联网金融应该充当毛细血管的角色-上海法治声音</a></dd>
        </dl>
      </div>
    ...
    <!--about-->
    <div class="mt10 bd bdr">
      <div class="hd clearfix"><a href="about.jsp" class="more">更多&gt;&gt;</a>关于我们</div>
