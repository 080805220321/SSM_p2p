...
<div class="wrap mt10">
  <div class="bg-w bdr">
    <div class="pd20">
      <!--invest-->
      <div class="crumbs clearfix" style="margin-bottom:20px;"><a href="invest.jsp" class="ico back">返回</a><span>我要投资</span><a href="#" class="ico Prompt loginbtn indent">您尚未登录</a></div>
...
融桥担保审核并被推荐至十七金融；推荐方提供全额本息担保。十七金融于……<!--<a href="#" class="o">[详情]</a>--></div>
        ...
        <div class="rbox bdr fr">
          ...
          <div class="pd20">
            ...
            <div class="mt10">预期收益 ¥ 13,537.55<br>担保机构：安徽融桥担保股份有限公司</div>
