...
public class JuHe_PhoneNote {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="26805c78f0394878207c27c59b932764";


    //2.发送短信
    public static void mobileQuery(String phone,String tpl_value){
        String result =null;
    ...
    public static void main(String[] args) {
        mobileQuery("13075646046","#code#=55555");
    }
