...
public interface StaffMapper {
    ...
    //获得所有员工信息和该员工角色
    @Select("SELECT st.staff_id staffId, st.staff_name staffName, st.staff_pwd staffPwd, ro.role_name roleName, de.dept_name deptName, st.staff_state staffState FROM tb_staff st,tb_role ro,tb_dept de,tb_staff_role_dept srd WHERE st.staff_id=srd.staff_id AND srd.dept_id=de.dept_id AND srd.role_id=ro.role_id")
    List<Map<String,Object>> getStaffAll_admin();

    //添加员工返回员工ID
    int insertStaff_ID(Staff staff);
